% TDA Reaccion
% Composicion: [IdPR, IdR, FechaR, CuentaCreadoraR, TipoR, ContenidoR]
...
esReaccion(R) :- getIdPR(R, IdPR), getIdP(R, IdR), getFechaR(R, Fecha), getCuentaR(R, Cuenta), getTipoR(R, TipoR), getContenidoR(R, ContenidoR),
